...
document.getElementById("rack_name").addEventListener("change", set_max_pos);
window.addEventListener("load", set_max_pos);

function check_rack_value() {
    return document.getElementById("rack_name").value;
}

function set_max_pos() {
    ...
    const rack_val = check_rack_value();
    if (rack_pos.value) {
