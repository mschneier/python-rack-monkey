...
window.addEventListener("load", () => {
    window.start_rack = document.getElementById("rack_name").value;
    window.start_pos = document.getElementById("rack_pos").value;
});
...
function check_occupied_slot() {
    ...
    if (rack && rack_pos) {
        if (rack == window.start_rack && rack_pos == window.start_pos) {
            rack_msg.style.display = "";
            rack_msg.classList = "info";
            rack_msg.innerText = "Original";
